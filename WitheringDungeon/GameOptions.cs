public static class GameOptions
{
    ...
    public static string[] TryTwistedDoor = new string[]
    {
        "0. Cast a Spell",
        "1. Try attacking the door"
    };
    public static string[] TryTwistedDoorOther = new string[]
    {
        "Cast a Spell",
        "Try attacking the door",
        "2. Try Something else.."
    };
    public static string[] OpenPack = new string[]
    {
        "0. Look inside your pack"
    };
    public static string[] WhatWisp = new string[]
    {
        "0. Ask the Wisps intentions"
    };
    public static string[] TakeShards = new string[]
    {
        "0. Take the 3 shards from your pack"
    };
    public static string[] HoldTighter = new string[]
    {
        "0. Grip Tighter"
    };
    public static string[] Release = new string[]
    {
        "0. LET GO!"
    };
    public static string[] OpenBlack = new string[]
    {
        "0. Try the key in the key hole"
    };
    public static string[] WitherNav = new string[]
    {
        "0. Investigate Grate",
        "1. Investigate Hole in ceiling",
        "2. Go over to stone shelf"
    };
