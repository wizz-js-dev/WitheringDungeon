public static class ForeverCorridor
{
    public static List<string> EnterCorridor = new List<string>
    {
    ...
    public static List<string> SpellOnDoor = new List<string>
    {
        "You gather your magic and Cast 'Energy Blast'",
        "You raise your hand and energy flies from it towards the lock",
        "The burst of light hits the key hole and dissapates into nothingness",
        "The door doesnt move.."
    };
    public static List<string> SwordOnDoor = new List<string>
    {
        "You unsheath 'Serpents Fang' and with your eyes held tightly shut, charge with full force towards the dark door",
        "You bring your sword down to strike the metal, but feel only empty air before you",
        "You stop running to creep carefully forward, swinging out with the blade and still, nothing",
        "You gingerly peak towards the floor to see how far from the door you are",
        "You discover you are still standing where you started, having moved not an inch forward.."
    };
    public static List<string> PackWisp = new List<string>
    {
        "As you try to think of another approach, you feel a tugging on your pack as if it was suddenly heavier..",
        "You turn away from the Twisted Door and look at the pack noticing a shifting white light coming from within"
    };
    public static List<string> Shards = new List<string>
    {
        "You open the pack and from inside, a sparkling white Wisp gently floats out, stopping right in front of your face, as if to look you in the eye",
        "What is it trying to say.."
    };
    public static List<string> WispConvo = new List<string>
    {
        "For the first time it dawns on you to try talking to the strange creature(?)",
        "You clear your throat and ask..",
        "'What are you?'",
        "The floating entity doesnt react, it simply stares(?) back at you..",
        "'What do you want?'",
        "..nothing..",
        "You narrow your eyes, suspiciously",
        "'Is it..my bag? Is there something in my bag?'",
        "At that the Wisp starts bobbing excitedly"
    };
    public static List<string> LookInBag = new List<string>
    {
        "You look down into your bag and take stock of its contents"
    };//log out inventory

    public static List<string> TwistedMetalForge = new List<string>
    {
        "You pull the three 'Twisted Black Metal Shards' from your pack and hold them in front of you",
    ...
    public static List<string> Forging = new List<string>
    {
        "You grip the shards tighter and the heat grows stronger",
        "The heat starts to burn the palms of your hands",
        "The air around your hands shimmers with the heat",
        "Youre not sure how much longer you can stand the PAIN",
        "THE PAIN GROWS SO MUCH THAT YOU FEAR YOUR HANDS WILL BURN AWAY.."
    };
    public static List<string> TwistedKey = new List<string>
    {
    ...
    public static List<string> OpenBlackDoor = new List<string>
    {
