...
{
    public static List<string> Enter = new List<string>
    {
        ...
        "On the other side of the room you can see a small break in the black metal of the wall, with a small stone shelf sticking out",
        "As you look on, you begin to hear a cacophony of whispers building in volume coming from all around"
    };
    public static List<string> DoubleChk = new List<string>
    {
        "You haven't looked at everything else in the room yet",
        "Are you sure want to go straight over to the shelf?"
    };
    public static List<string> Grate = new List<string>
    {
    ...
    public static List<string> CeilingHole = new List<string>
    {
    ...
    public static List<string> Shelf = new List<string>
    {
        "You cross the room, avoiding the fumes at the centre and make for the small shelf poking through the tormented metal walls",
        "Sitting on it you find a small scroll which looks like it was rolled up in a hurry"        
    };
    public static List<string> AfterScroll = new List<string>
    {
    ...
    public static List<string> TheWitheringShade = new List<string>
    {
    ...
    public static List<string> FightStart = new List<string>
    {
        "You straighten up and face the vile creature in front of you",
        "This is it, the last challenge in your long and arduous journey",
        "You feel the weight of your mission, of the future of your people on your shoulders and you bare it with a fierce determination",
        "What is your first move?.."
    };
    public static List<string> AlmostDead = new List<string>
    {
        "The Withering shade stumbles on its many legs and cries out in pain",
        "It seems weakened now, as if one final blow might just finish it off",
        "The beast drags itself forward toward you, readying itself for another attack",
        "As it draws closer, it stumbles again, coming to  a stop over the grate in the floor, being surrounded by the noxious fumes rising from below"
    };
    public static List<string> FireFumes = new List<string>
    {
        "You summon a ferocious flame from within your very core and release it towards the grate in the chamber floor",
        "As the jet reaches the fumes, the ignight and surround the Withering Shade in vicious, licking flames",
        "The creature lets loose screams from every one of its mouths as the fire burns every gnarled surface of its body",
        "A twisted limb reaches out and stabs into the ground between you",
        "The beast drags itself forward, slowly, to escape the still burning gas",
        "The appendage once again lifts up and smashes into the ground 10 feet in front of you, shaking the entire chamber",
        "Small rocks fall from the cieling and come clattering down atop the creature",
        "You look up to see, directly above the nearing beast, the outcropping of rock barely holding on to the ceiling around it"
    };
    public static List<string> ArrowRock = new List<string>
    {
        "The Witherng Shade is close now and you are almost within its reach",
        "You pull your last arrow from its quiver and nock it on Featherflight",
        "You pull back the drawstring and aim towards the thin sliver of stone securing the rock",
        "You close your eyes and take a deep breath, praying you hit your target",
        "You open your eyes to find, as if in response to your fervent wish, the arrow has begun to glow",
        "Every cell in your body begins to vibrate as you pour all your hopes, all your magical power into the arrow",
        "You release the bowstring and the shining arrow flies away from you, sending a rush of wind backwards, knowcking you to the ground",
        "As the arrow reaches the ceiling and hits its target, an explosion of energy bursts from it, completely sheering the rock from its tether",
        "The rock falls towards the chamber floor and lands with a crash on top of the burnt Shade with a loud crunch",
        "The creature squirms beneath the rock, lifting itself up as if to cast its burden off",
        "One of its many limbs breaks away from its body and disintegrates into shadow",
        "The Shade continues to struggle, moving back away from you as it rises up to its full height and tipping the rock off of it"
    };
    public static List<string> BattleWin = new List<string>
        {
        "The creature writhes with rage, letting loose a piercing shriek that shakes the room and pierces your entire body",
        "It rights itself and makes to charge at you",
        "You gather what power you have left to let loose one final attack",
        "The Shade, with what little strength it has left, leaps halfway accross the room, closing the gap between you",
        "You let loose power from your hand, aimed at the beast, but nothing happens. You have no energy left to attack..",
        " The Withering Shade readies itself to pounce again..",
        "You draw the Serpents Fang and make to charge forward",
        "Suddenly with a crash, the wall where the door used to be explodes inwards",
    ...
    public static List<string> EndingFork = new List<string>
        {
    ...
    public static List<string> TheTashKar = new List<string>
        {
